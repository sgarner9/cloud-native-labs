            ...
            script {
                openshift.withCluster {
                    openshift.withProject('user11') {
                        ...
                        openshift.tag("coolstore/gateway:latest", "user11/gateway-canary:latest")
                    }
                }
            }
        }
        ...
        script {
            openshift.withCluster() {
                openshift.withProject('user11') {
                    ...
                    openshift.tag("user11/gateway-canary:latest", "user11/gateway:latest")
